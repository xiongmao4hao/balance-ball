...
//    Endian       =  little
//    Source file  =  
//        C:\Users\shize\Desktop\电设\bloodc\lib\LPLD\DEV\DEV_SCCB.c
//    Command line =  
//        C:\Users\shize\Desktop\电设\bloodc\lib\LPLD\DEV\DEV_SCCB.c -D
...
//   41   ptb.GPIO_PTx = PTC;
        ...
        STR      R0,[SP, #+4]
//   42   ptb.GPIO_Pins = GPIO_Pin10|GPIO_Pin11;
        MOV      R0,#+3072
        STR      R0,[SP, #+8]
//   43   /********用户可修改值 结束***********/
...
//  155   SCCB_SDA_O=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_1  ;; 0x43fe102c
        STR      R0,[R1, #+0]
//  156   SCCB_SCL=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_2  ;; 0x43fe1028
        STR      R0,[R1, #+0]
//  157   SCCB_DELAY();
        MOVW     R0,#+5000
        BL       LPLD_SCCB_Delay
...
//  159   SCCB_SDA_IN();
        MOVS     R0,#+0
        LDR.N    R1,??DataTable7_3  ;; 0x43fe12ac
        STR      R0,[R1, #+0]
//  160   if(!SCCB_SDA_I)
        LDR.N    R0,??DataTable7_4  ;; 0x43fe122c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
